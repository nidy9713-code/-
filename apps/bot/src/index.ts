...
bot.hears('🎁 Пробный урок', async (ctx) => {
  ...
  // Здесь будет логика выдачи первого урока из базы
  await ctx.reply('Смотри видео и выполняй упражнение: [Ссылка на видео]');
});
