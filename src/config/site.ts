...
export const hero = {
  ...
  stats: [
    ...
    { value: "4 модуля", label: "программы" },
    { value: "24 занятия", label: "в курсе" },
  ],
} as const;
...
export const pricing = {
  ...
  miniCourse: {
    ...
    description:
      "Попробуйте платный мини-курс (от 5 000 ₽) — короткий формат с ключевыми упражнениями",
  ...
  items: [
    {
      ...
      answer: "Да, вокалом можно заниматься в любом возрасте. У нас много учеников 30+ и 40+, которые начали «с нуля» и достигли отличных результатов.",
    },
    {
      question: "Если у меня нет слуха, получится?",
      answer: "Слух — это навык, который тренируется. Наши упражнения разработаны специально для развития координации между слухом и голосом, даже если вам кажется, что вы «не попадаете в ноты».",
    },
    {
      question: "Сколько времени нужно в день?",
      answer: "Достаточно 15–20 минут. Уроки короткие, их легко встроить в обычный рабочий день. Главное — регулярность.",
    },
    {
      question: "Подходит ли курс новичкам?",
      answer: "Да, курс рассчитан именно на тех, кто никогда не занимался вокалом или имеет минимальный опыт и хочет убрать зажимы.",
    },
    {
      question: "Как открыть доступ?",
      answer: "После оплаты вы получите ссылку на Telegram-бот, где будут открываться уроки и приходить напоминания.",
    },
    {
      question: "Как проходит поддержка?",
      answer: "На тарифах «Стандарт» и «Премиум» вы получаете обратную связь от преподавателя по вашим аудио и видео записям.",
    },
    {
      question: "Что делать, если я пропущу занятие?",
      answer: "Все уроки остаются у вас в записи. Вы можете проходить их в своём темпе, когда вам удобно.",
    },
    {
      question: "Будет ли сертификат?",
      answer: "Да, после прохождения всех модулей и выполнения финального задания вы получите электронный сертификат о прохождении курса.",
    },
  ],
} as const;
