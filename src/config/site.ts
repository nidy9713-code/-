...
export const hero = {
  eyebrow: "Онлайн-курс вокала",
  title: "Пойте уверенно — без страха и зажимов",
  subtitle:
    "Авторский курс Софьи Переверзевой: короткие уроки с телефона, поддержка и путь от страха к сцене.",
...
export const about = {
  ...
  psychologist: {
    ...
    bio: "Специализируется на работе с самооценкой и страхом публичных выступлений. Помогает проработать внутренние барьеры, мешающие звучать свободно.",
    achievements: [
      "Клинический психолог",
      "10+ лет практики",
      "Эксперт по работе с зажимами",
    ],
  },
} as const;
