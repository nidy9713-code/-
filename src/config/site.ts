...
export const hero = {
  eyebrow: "Онлайн-курс вокала «Звезда караоке»",
  title: "Научись петь уверенно и с удовольствием!",
  subtitle: "даже если сейчас боишься фальшивить и слышать чужие оценки",
  cta: "ХОЧУ ПЕТЬ УВЕРЕННО",
  ctaHint: "Подходит даже если ты никогда не занималась вокалом",
  stats: [
    { value: "15+ лет", label: "обучаем музыке" },
    { value: "1000+", label: "учеников" },
    { value: "Онлайн", label: "по всему миру" },
...
export const about = {
  ...
  psychologist: {
    name: "Кливакова Елена Сергеевна",
    role: "Клинический психолог и гештальт-терапевт",
    image: "/images/psychologist.png",
    bio: "Специализируется на тревоге, страхах, низкой самооценке и эмоциональных зажимах. Помогает проработать состояния, когда перед выходом на сцену трясутся руки и перехватывает дыхание.",
    achievements: [
      "Опыт более 6 лет",
